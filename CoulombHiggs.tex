...
% Below is a very weird function to define, since it will obviously highly depend on the choice of slope. Only certain slopes should be allowed.
...
\defn{CrystalWeight}{\vardef{hMat}, \vardef{fMat}, \vardef{theta},  \vardef{phi},  \vardef{Crys}}
...
{computes the sign of $\cos\theta ( \lambda_1 \cos\phi + \lambda_2 \sin\phi ) + 
\lambda_3 \sin\theta $, where $\lambda=\lambda_1 h_1 + \lambda_2 h_2 + \lambda_3 h_3$,
